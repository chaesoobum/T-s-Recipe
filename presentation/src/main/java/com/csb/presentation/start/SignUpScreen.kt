        ...
        Column(
            ...
            Column(
                ...
                Text(
                    ...
                    fontFamily = FontFamily(Font(R.font.roboto_regular)),
                    fontSize = 14.sp,
                    color = colorResource(id = R.color.color9D9D9D)
                )
                ...
                OutlinedTextField(
                    ...
                    paddingStart = 10.dp,
                    paddingEnd = 10.dp,
                    placeHolder = stringResource(id = R.string.exEmail_com)
                )
                CustomBoxOutlineButton(
                    modifier = Modifier
                        .fillMaxWidth()
                        .padding(start = 10.dp, end = 10.dp, top = 15.dp),
                    text = stringResource(id = R.string.strContinue),
                    textFont = FontFamily(Font(R.font.roboto_regular)),
                    onClick = { },
                    buttonColor = colorResource(id = R.color.textColor8c8c8c),
                    borderColor = colorResource(id = R.color.textColor8c8c8c),
